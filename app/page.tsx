    ...
    <div className="flex-grow bg-[#F8FAFC] text-[#111827] font-sans selection:bg-[#4F46E5] selection:text-white">
      ...
      <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
          {[
            { icon: ImageIcon, title: 'AI Image Generator', desc: 'Generate stunning images from text using advanced AI models.', color: 'text-white', bg: 'bg-[#6D5EF8]', slug: '/tools/ai-image-generator' },
            { icon: LayoutGrid, title: 'Background Remover', desc: 'Remove background from any image instantly with AI precision.', color: 'text-white', bg: 'bg-[#10B981]', slug: '/tools/background-remover' },
            { icon: PenTool, title: 'AI Writer', desc: 'Write blogs, emails, articles, and more in seconds.', color: 'text-white', bg: 'bg-[#F43F5E]', slug: '/tools/ai-writer' },
            { icon: Video, title: 'AI Video Generator', desc: 'Generate videos from text with realistic AI visuals.', color: 'text-white', bg: 'bg-[#8B5CF6]', slug: '/tools/ai-video-generator' },
            { icon: Code, title: 'AI Code Generator', desc: 'Generate clean code in any programming language.', color: 'text-white', bg: 'bg-[#0EA5E9]', slug: '/tools/ai-code-generator' },
          ].map((tool, i) => (
