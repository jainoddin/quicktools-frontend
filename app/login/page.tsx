        ...
        <div className="w-full max-w-[440px]">
          ...
          <div className="space-y-4">
            ...
            <div className="animate-stagger-2">
              <GoogleLoginButton className="w-full flex items-center justify-center gap-3 bg-white border-2 border-[#E5E7EB] hover:border-[#6D5EF8] hover:bg-[#F0EFFF] hover:shadow-md text-[#111827] font-bold text-sm px-6 py-3.5 rounded-xl transition-all duration-300">
            ...
            <div className="animate-stagger-3">
              <GitHubLoginButton className="w-full flex items-center justify-center gap-3 bg-white border-2 border-[#E5E7EB] hover:border-gray-900 hover:bg-gray-50 hover:shadow-md text-[#111827] font-bold text-sm px-6 py-3.5 rounded-xl transition-all duration-300">
