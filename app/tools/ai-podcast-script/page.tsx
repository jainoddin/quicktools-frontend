...
export const metadata: Metadata = {
  title: 'AI Podcast Episode Script | QuickTools.ai',
  description: 'Generate structured scripts for podcast episodes.',
    ...
    openGraph: {
            ...
            type: 'website',
            images: [{ url: `https://quicktool.space/api/og?title=${encodeURIComponent("AI Podcast Episode Script")}&type=tool`, width: 1200, height: 630, alt: `AI Podcast Episode Script - QuickTools.ai` }]
          },
    twitter: {
