...
export default function AiResumeBuilderPage() {
  return (
    <div className="flex-grow bg-[#F8FAFC] flex flex-col font-sans selection:bg-[#8B5CF6] selection:text-white relative">
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-fuchsia-100/30 rounded-full blur-[120px] -translate-x-1/4 translate-y-1/4"></div>
      </div>
      ...
      <div className="max-w-[1440px] w-full mx-auto px-4 sm:px-6 lg:px-8 pb-8 pt-[15px] flex-grow flex flex-col relative z-10">
        <div className="flex items-center mb-[25px]">
          <nav className="flex items-center space-x-2 text-sm font-medium text-[#6B7280]">
            ...
            <ChevronRight className="w-4 h-4 text-gray-400" />
            <span className="text-[#8B5CF6] font-bold">AI Resume Builder</span>
          </nav>
        </div>
