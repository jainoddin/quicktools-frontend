...
export const metadata: Metadata = {
  ...
  description: 'Generate slide-by-slide text, data points, and script for a startup pitch deck.',
    ...
    openGraph: {
            ...
            type: 'website',
            images: [{ url: `https://quicktool.space/api/og?title=${encodeURIComponent("AI Pitch Deck Generator")}&type=tool`, width: 1200, height: 630, alt: `AI Pitch Deck Generator - QuickTools.ai` }]
          },
    twitter: {
