...
import AiSalesFunnelClient from '@/components/ai-sales-funnel/AiSalesFunnelClient';
...
export const metadata: Metadata = {
  ...
  description: 'Write landing page copy, email sequences, and ad copy all at once.',
    ...
    openGraph: {
            ...
            type: 'website',
            images: [{ url: 'https://quicktool.space/icon.svg', width: 1200, height: 630, alt: 'Premium AI Sales Funnel Copywriter' }]
          },
    twitter: {
      ...
      <div className="flex-1 w-full max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8 py-6 h-[calc(100vh-80px)]">
        <div className="flex items-center mb-[25px]">
          <nav className="flex items-center space-x-2 text-sm font-medium text-[#6B7280]">
            ...
            <ChevronRight className="w-4 h-4 text-gray-400" />
            <span className="text-[#6D5EF8] font-bold">AI Sales Funnel Copywriter</span>
          </nav>
        </div>
        <AiSalesFunnelClient />
      </div>
