...
export const metadata: Metadata = {
  ...
  description: "Generate configurable randomized passwords using our free Strong Password Generator.",
    ...
    openGraph: {
            ...
            type: 'website',
            images: [{ url: `https://quicktool.space/api/og?title=${encodeURIComponent("Strong Password Generator")}&type=tool`, width: 1200, height: 630, alt: `Strong Password Generator - QuickTools.ai` }]
          },
    twitter: {
