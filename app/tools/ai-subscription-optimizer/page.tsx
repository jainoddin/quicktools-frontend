        ...
        <div id="faq" className="mt-16 bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-2">Yes, the Subscription Optimizer generates original text based on its training data and your prompts. While highly unique, we always recommend reviewing and lightly editing the output before publishing.</p>
            </div>
            <div>
