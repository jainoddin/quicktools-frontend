...
import AiWebinarScriptClient from '@/components/ai-webinar-script/AiWebinarScriptClient';
...
export const metadata: Metadata = {
  ...
  description: 'Generate engaging scripts for your webinars.',
    ...
    openGraph: {
            ...
            type: 'website',
            images: [{ url: 'https://quicktool.space/icon.svg', width: 1200, height: 630, alt: 'AI Webinar Script Generator' }]
          },
    twitter: {
  ...
  return (
    <div className="flex-1 w-full max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8 py-6 h-[calc(100vh-80px)]">
      ...
      <nav className="flex items-center gap-2 text-sm text-[#6B7280] mb-6 animate-in fade-in slide-in-from-left-4 duration-500">
        ...
        <ChevronRight className="w-4 h-4" />
        <span className="text-[#111827] font-semibold flex items-center gap-1.5"><Sparkles className="w-4 h-4 text-[#F59E0B]" /> Webinar Script Generator</span>
      </nav>

      <AiWebinarScriptClient />
    </div>
  );
}
