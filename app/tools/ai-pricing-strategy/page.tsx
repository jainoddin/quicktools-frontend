...
import AiPricingStrategyClient from '@/components/ai-pricing-strategy/AiPricingStrategyClient';
    ...
    <div className="flex-1 w-full max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8 py-6 h-[calc(100vh-80px)]">
            ...
            "description": "Generate optimized pricing strategies and tiers."},
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "AI Pricing Strategy Generator", "item": "https://quicktool.space/tools/ai-pricing-strategy" }
        ]
      }
    ]) }}
      />
      ...
      <nav className="flex items-center gap-2 text-sm text-[#6B7280] mb-6 animate-in fade-in slide-in-from-left-4 duration-500">
        ...
        <ChevronRight className="w-4 h-4" />
        <span className="text-[#111827] font-semibold flex items-center gap-1.5"><Sparkles className="w-4 h-4 text-[#F59E0B]" /> Pricing Strategy Generator</span>
      </nav>

      <AiPricingStrategyClient />
    </div>
  );
}
