...
export const metadata: Metadata = {
  title: 'AI Grant Progress Report | QuickTools.ai',
  description: 'Write professional progress reports for grants.',
    ...
    openGraph: {
            ...
            type: 'website',
            images: [{ url: `https://quicktool.space/api/og?title=${encodeURIComponent("AI Grant Progress Report")}&type=tool`, width: 1200, height: 630, alt: `AI Grant Progress Report - QuickTools.ai` }]
          },
    twitter: {
