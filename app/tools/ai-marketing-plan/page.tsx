...
export const metadata: Metadata = {
  ...
  description: 'Generate a comprehensive marketing plan and strategy.',
    ...
    openGraph: {
            ...
            type: 'website',
            images: [{ url: `https://quicktool.space/api/og?title=${encodeURIComponent("AI Marketing Plan Generator")}&type=tool`, width: 1200, height: 630, alt: `AI Marketing Plan Generator - QuickTools.ai` }]
          },
    twitter: {
