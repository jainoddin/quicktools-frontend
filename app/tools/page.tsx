...
export default function AllToolsPage() {
  return (
    <div className="bg-[#F8FAFC] text-[#111827] font-sans selection:bg-[#6D5EF8] selection:text-white">
              ...
              <div className="space-y-1">
                {categories.map((category, index) => {
                  ...
                  return (
                    <button
                      key={index}
                      className={`w-full flex items-center justify-between px-3 py-2.5 rounded-xl transition-all ${category.active
                    ...
                    >
                      ...
                      <span className={`text-xs ${category.active
            ...
            <div className="flex flex-wrap items-center gap-2.5 mb-8">
              {filters.map((filter, idx) => {
                ...
                return (
                  <button
                    key={idx}
                    className={`flex items-center gap-2 px-4 py-2 rounded-xl text-[14px] font-semibold transition-all shadow-sm ${filter.active
