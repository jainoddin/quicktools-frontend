    ...
    <div className="flex-grow bg-[#F8FAFC] flex flex-col font-sans selection:bg-[#6D5EF8] selection:text-white relative">
            ...
            , "featureList": "AI-powered, fast generation, free to use, no signup required for basic use"},
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "QuickTools AI Tool", "item": "https://quicktool.space/tools/url-shortener" }
        ]
      },
      {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "What is QuickTools AI Tool?", "acceptedAnswer": { "@type": "Answer", "text": "The QuickTools AI Tool is an advanced AI-powered tool by QuickTools designed to help you shorten any long url into a clean, shareable link in one click with our free url shortener." } },
        ...
        <div id="faq" className="mt-16 bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-600 mt-2">The QuickTools AI Tool is an advanced AI-powered tool by QuickTools designed to help you shorten any long url into a clean, shareable link in one click with our free url shortener.</p>
            </div>
            <div>
