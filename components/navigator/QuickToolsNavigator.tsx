...
const GREETING = "Hi, I'm QuickTools AI. What can I help you find or do?";
const ROUTES = [
  ...
  { terms: ['courses', 'learn', 'academy', 'లెర్న్', 'सीखें'], path: '/learn', label: 'QuickTools Learn' },
...
export default function QuickToolsNavigator() {
  ...
  return <div ref={navigatorRef} className="fixed right-3 z-[180] transition-[bottom] duration-150 sm:right-6" style={{ bottom: open ? viewportBottom : navigatorBottom }}>
    ...
    {!open && <button onClick={openPanel} className="relative ml-auto flex h-24 w-24 items-center justify-center overflow-hidden bg-transparent shadow-none transition-transform hover:scale-105 sm:h-28 sm:w-28" aria-label="Open QuickTools AI"><Lottie animationData={quickToolsAiAnimation} loop autoplay className="w-full h-full -translate-x-[12%] scale-[1.85] pointer-events-none" aria-hidden /></button>}
  </div>;
}
