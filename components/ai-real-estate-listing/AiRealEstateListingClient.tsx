...
import { Download, Home, History, Loader2, Copy, CheckCircle2, Sparkles, Target } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-[#111827] flex items-center gap-2">
                    AI Real Estate Listing Generator <Sparkles className="w-5 h-5 text-[#10B981]" />
                  </h1>
                  <p className="text-sm text-[#6B7280]">Creates engaging property descriptions for real estate agents.</p>
                </div>
              </div>
            ...
            <div className="flex gap-2">
              {result && (
                <>
                  ...
                  <button
                    onClick={() => downloadAsPDF(result, 'A I  Real Estate Listing')}
