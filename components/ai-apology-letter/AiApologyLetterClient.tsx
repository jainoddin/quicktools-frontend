...
import { Download, PenTool, History, Loader2, Copy, CheckCircle2, Sparkles, Target } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-[#111827] flex items-center gap-2">
                    AI Apology Letter Generator <Sparkles className="w-5 h-5 text-[#64748B]" />
                  </h1>
                  <p className="text-sm text-[#6B7280]">Write sincere, professional, or personal apology letters.</p>
                </div>
              </div>
            ...
            <div className="flex gap-2">
              {result && (
                <>
                  ...
                  <button
                    onClick={() => downloadAsPDF(result, 'A I  Apology Letter')}
