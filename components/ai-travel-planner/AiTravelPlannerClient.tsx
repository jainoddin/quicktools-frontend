...
import { Download, Map, History, Loader2, Copy, CheckCircle2, Sparkles, Target } from 'lucide-react';
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-[#111827] flex items-center gap-2">
                    AI Travel Itinerary Planner <Sparkles className="w-5 h-5 text-[#14B8A6]" />
                  </h1>
                  <p className="text-sm text-[#6B7280]">Create detailed daily travel plans for any destination.</p>
                </div>
              </div>
            ...
            <div className="flex gap-2">
              {result && (
                <>
                  ...
                  <button
                    onClick={() => downloadAsPDF(result, 'A I  Travel Planner')}
