...
export default function HistoryView({ onClose }: HistoryViewProps) {
  const images = [
    { id: 1, src: 'https://images.unsplash.com/photo-1605806616949-1e87b487cb2a?w=600&q=80', prompt: 'Futuristic city at sunset with...', date: 'Today, 2:30 PM', model: 'DALL-E 3' },
    { id: 2, src: 'https://images.unsplash.com/photo-1518780664697-55e3ad937233?w=600&q=80', prompt: 'Beautiful cabin in the mountains...', date: 'Today, 1:45 PM', model: 'DALL-E 3' },
    { id: 3, src: 'https://images.unsplash.com/photo-1614730321146-b6fa6a46bcb4?w=600&q=80', prompt: 'Astronaut sitting on mars...', date: 'Today, 11:20 AM', model: 'DALL-E 3' },
    { id: 4, src: 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=600&q=80', prompt: 'Cute puppy playing in the garden...', date: 'Today, 10:10 AM', model: 'DALL-E 3' },
    { id: 5, src: 'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=600&q=80', prompt: 'Fantasy landscape with floating...', date: 'Yesterday, 6:30 PM', model: 'DALL-E 3' },
    { id: 6, src: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&q=80', prompt: 'Modern living room interior...', date: 'Yesterday, 4:15 PM', model: 'DALL-E 3' },
    { id: 7, src: 'https://images.unsplash.com/photo-1542362567-b07e54358753?w=600&q=80', prompt: 'Sports car in rainy night city...', date: 'Yesterday, 2:40 PM', model: 'DALL-E 3' },
    { id: 8, src: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=600&q=80', prompt: 'Cute robot watering a plant...', date: 'Yesterday, 12:05 PM', model: 'DALL-E 3' },
  ];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6">
        {images.map((img) => (
          <div key={img.id} className="bg-white rounded-2xl border border-[#E5E7EB] overflow-hidden shadow-sm hover:shadow-md hover:border-gray-300 transition-all group flex flex-col">
            {/* Image Box */}
            <div className="relative aspect-video sm:aspect-[4/3] w-full overflow-hidden shrink-0 bg-gray-100">
              <Image src={img.src} alt={img.prompt} fill className="object-cover group-hover:scale-105 transition-transform duration-500" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw" />
