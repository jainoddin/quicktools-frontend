    ...
    <div className="flex flex-col lg:flex-row gap-6 items-stretch">
      <div className="w-full lg:w-1/2 flex flex-col gap-5">
        <div className="bg-white border border-[#E5E7EB] rounded-3xl p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-purple-100 flex items-center justify-center text-[#8B5CF6]">
          ...
          <textarea
            ...
            className="w-full h-64 p-4 bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl focus:border-[#8B5CF6] outline-none resize-none text-[15px]"
          />
          <button
            onClick={handleGenerate}
            disabled={isProcessing || !details.trim()}
            className="w-full mt-4 bg-[#8B5CF6] hover:bg-purple-600 text-white font-bold py-4 rounded-2xl shadow-md transition-all flex items-center justify-center disabled:opacity-50"
          >
            {isProcessing ? (
      ...
      <div className="w-full lg:w-1/2">
        <div className="bg-white border border-[#E5E7EB] rounded-3xl p-6 shadow-sm h-full flex flex-col">
          ...
          <div className="flex-1 bg-[#F9FAFB] border border-[#E5E7EB] rounded-2xl p-5 overflow-y-auto whitespace-pre-wrap font-mono text-sm text-gray-800">
            {result || (
